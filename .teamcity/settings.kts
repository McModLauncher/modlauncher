...
project {
    ...
    params {
        ...
        text("docker_gradle_version", "6.3", label = "Gradle version", description = "The version of Gradle to use during execution of Gradle tasks.", display = ParameterDisplay.HIDDEN, allowEmpty = false)
    ...
    features {
        githubIssues {
            id = "modlauncher__IssueTracker"
            displayName = "McModLauncher/modlauncher"
            repositoryURL = "https://github.com/McModLauncher/modlauncher"
        }
    }
}
